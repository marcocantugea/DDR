...
#Region "Load Grids"
    ...
    Private Sub LoadDrillStringGrid()
        ...
        dgv_String.Columns(7).ReadOnly = True
        dgv_String.Columns(7).Width = 35
    End Sub
        ...
        For Each row As DataGridViewRow In dgv_String.Rows
            ...
            If row.Cells(0).Value <> "" Then
                ...
                If Not IsNothing(row.Cells(7).Value) Then
                    drillstring_row.DrillString_ID = row.Cells(7).Value
                End If
